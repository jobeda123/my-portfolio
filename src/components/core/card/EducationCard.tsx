...
import Achievements from '../../education/Achievements';
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8 relative">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
        <div className="flex-1">
          <div className={'inline-flex px-3 py-1 rounded-full text-sm font-medium mb-3 bg-emerald-100 text-emerald-800'}>
            {period}
          </div>
