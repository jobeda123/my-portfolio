...
export const experienceIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const testimonialsIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
 ...
 export const blogIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  ...
  export const FallBackIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
        className={className}
        fill="none"
        stroke="currentColor"
