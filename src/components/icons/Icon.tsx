...
const ProjectsIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
const WebsiteIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
const iconMap = {
  ...
  email: EmailIcon,
  mobile: MobileIcon,
  services: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  skills: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  experience: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  blog: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  testimonials: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  resume: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
